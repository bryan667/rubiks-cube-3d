export interface FaceHideEntry {
    face: number;
    pos: number;
}

export interface FacesToHide {
    face1: FaceHideEntry[];
    face2: FaceHideEntry[];
    face3: FaceHideEntry[];
    face4: FaceHideEntry[];
    ...
    face8: FaceHideEntry[];
    face9: FaceHideEntry[];
    face10: FaceHideEntry[];
    face11: FaceHideEntry[];
    face12: FaceHideEntry[];
    [key: string]: FaceHideEntry[];
}

let facesToHide: FacesToHide = {
    // Blue
    face1 : [
        // Pink side
